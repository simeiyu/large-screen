...
var convertLineData = function(geoCoordMap, data, targ, type) {
    var res = [];
    for (var i = 0; i < data.length; i++) {
        var dataItem = data[i];
        var fromCoord = geoCoordMap[dataItem.name];
        ...
        if (fromCoord && toCoord) {
            if(type=="sub" && fromCoordWd < toCoordWd) {
                res.push({
            ...
            if(type=="sup" && fromCoordWd >= toCoordWd) {
                res.push({
                    fromName: dataItem.name,
                    toName: targ,
                    coords: [fromCoord, toCoord]
...
var map_option = {
    ...
    series: [
        ...
        // 线
        {
            ...
            data: convertLineData(geoCoordMap, data, '北京', 'sub')
        }, 
        {
            name: '线-北',
            type: 'lines',
            ...
            //     trailLength: 0
            // },
            data: convertLineData(geoCoordMap, data, '北京', 'sup')
        }, 
        {
            name: '箭头',
            type: 'lines',
            ...
            data: convertData(geoCoordMap, data, '北京')
        }
    ]
};
