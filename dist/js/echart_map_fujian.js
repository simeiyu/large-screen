    ...
    series: [
        {
            ...
            data: cityData(geoCoordMap, map_data, "福州市")
        }, 
        // 线 
        {
            name: '线',
            ...
            data: convertLineData(geoCoordMap, map_data, '福州市')
        },
        // 箭头
        {
            name: '箭头',
            ...
            data: convertData(geoCoordMap, map_data, '福州市')
        }
    ]
};
var fj_chart = echarts.init(document.getElementById('map_fujian'));
fj_chart.setOption(fj_option);